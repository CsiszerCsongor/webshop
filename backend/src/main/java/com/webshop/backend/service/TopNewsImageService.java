...
public class TopNewsImageService {
    ...
    public List<TopNewsImageDTO> getTopNewsImage() throws IOException {
        ...
        //
        //Első perctől voltak konfliktusok a nézeteltérések, összeszólalkozások amit egy darabig tűrtek és egy idő után már nem tűrtek, a vallás miatt voltak megszólítások,
        // anyáskodni akart az egyik személy felett, nem ittam, nem szivaraztam, túl sokat megyek vallási helyekre,
        ...
        //Ők csak arra hivatkoztak,... de nem fogadtam el eztet, mert voltak olyan munkák, amiket ki tudtak kerülni, hogy ne az én módszeremmel csinálják meg, de volt olyan is,
        // amiket nem tudtak kikerülni, és nekem lett igazam, de azt meg sem említették, szóvá se tették. Illetve volt olyan nagyobb projekt is, aminél azt hittem, hogy nem
        // fogom tudni megcsinálni, végül mégis, magamat is meglepve, de meg tudtam csinálni
